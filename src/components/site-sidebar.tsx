...
export function SiteSidebar() {
  return (
    <aside
      ...
      className="relative order-2 border-t border-ink bg-ink text-ink-foreground lg:order-none lg:fixed lg:top-20 lg:left-0 lg:h-[calc(100vh-80px)] lg:overflow-y-auto lg:border-t-0"
    >
